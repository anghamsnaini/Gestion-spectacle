...
CREATE TABLE Client 
  (idClt INTEGER PRIMARY KEY ,
     ...
     *****************Création de séquance*********************  
CREATE SEQUENCE Seq
START WITH 1
MAXVALUE 500;
*****************Insertion Lieu****************************
INSERT INTO LIEU VALUES(1, 'CABARET RESTAURANT SHEHERAZADE','Médina Mediterranea - Yasmine-Hammamet - Tunisie',100);
INSERT INTO LIEU VALUES(2, 'THÉÂTRE EL HAMRA','28,rue El Jazira - Tunis - Tunisie',550);
INSERT INTO LIEU VALUES(3, 'Théâtre Municipal de Tunis','Avenue Bourguiba - Tunis - Tunisie',1099);
INSERT INTO LIEU VALUES(4, 'CINÉMA TUNISIA ODYSSÉE','Medina Mediterranea - Yasmine-Hammamet - Tunisie',435);
INSERT INTO LIEU VALUES(5, 'L''ÉTOILE DU NORD','41, avenue Farhat-Hached - Tunis - Tunisie',1067);
INSERT INTO LIEU VALUES(6, 'Pathé Tunis City','Cebalet ben ammar, route de bizerte km 17 Ariana, Tunis 2032, Tunisie',425);
...
INSERT INTO LIEU VALUES(11, 'Le Colisée','Avenue Habib Bourguiba, Tunis, Tunisie',1490);
...
INSERT INTO LIEU VALUES(14,	'Alhambra “zéphyr”','Centre Commercial Zéphyr La Marsa',958);
INSERT INTO LIEU VALUES(15,	'CinéMadart','Rue Hbib Bourguiba - Monoprix Dermech, Tunisie',866);
...
BEGIN
  ...
  RAISE_APPLICATION_ERROR(-20100, 'le nombre de spectateurs est superieur au capacité du lieu');
  END IF;
END;
